...
<?php 
  $mrkisanid = $_GET['Mrid'];
  $arraymr = array();
  $getkisanid = array('relation_creater'=>$mrkisanid);
  $kisan_get = $this->Main_model->getAllWheresun('kisan_info',$getkisanid);


  $getunid = array('mr_unid'=> $_GET['Mrid']);
  $un_id = $this->Main_model->getSingleRowByWhere('marketing_man',$getunid);
//   echo'<pre>';print_r($un_id->center_id);die
  $getcenter = array('un_center_id'=> $un_id->center_id);
  $center_name = $this->Main_model->getSingleRowByWhere('center',$getcenter);

//   $getcenters = array('center_id'=> $un_id->center_id);
//   $center_names = $this->Main_model->getSingleRowByWhere('marketing_man',$getcenters);
//   echo'<pre>';print_r($center_names);die;
?>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <title>Marketing to Kisan</title>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Center Name : <?php if(!empty($center_name)){ echo ucfirst($center_name->centername);}else if(!empty($un_id)){ echo ucfirst($un_id->center); }else{ echo'Admin';}?> And Kisan list</h5>
                                                    ...
                                                    <table class="table" id="dataTable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>City</th>
                                                                <th>Address</th>
                                                                <th style="text-align:center;">Marketing person<br/>Name</th>
                                                                <th>View</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <?php foreach($kisan_get as $kisan_list){?>
                                                            <tr>
                                                                <th><?php echo $kisan_list->kisan_un_id;?></th>
                                                                <td><?php echo ucfirst($kisan_list->kisan_full_name);?></td>
                                                                <td><?php echo $kisan_list->mobile_no;?></td>
                                                                <td><?php echo ucfirst($kisan_list->tehsil_name);?></td>
                                                                <td><?php echo ucfirst($kisan_list->full_address);?></td>
                                                                <th style="text-align:center"><?php echo ucfirst($un_id->username);?></th>
                                                                <td>
                                                                    <a href="<?php echo base_url('Crud/showKisanDetail/').$kisan_list->kisan_id;?>" class="btn btn-warning btn-sm">
                                                                        View Details
                                                                    </a>
                                                                </td>                                                             
                                                              </tr>
