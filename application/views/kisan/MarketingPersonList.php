...
if($mrsperson['role'] == '1' || $mrsperson['role'] == '2' || $mrsperson['role'] == '3'){
    if($mrsperson['role'] == '1'){
    $mrgetall = array('status'=>'active');
    $allgetmr = $this->Main_model->getAllWheresun('marketing_man',$mrgetall);
    }
    if($mrsperson['role'] == '2'){
    $mrgetall = array('status'=>'active','center_id'=>$mrsperson['username']);
    $allgetmr= $this->Main_model->getAllWheresun('marketing_man',$mrgetall);   
    }
    if($mrsperson['role'] == '3'){
        $querys = array( 'status'=>'active','center_id'=>$mrsperson['username']);
        $allgetmr = $this->Main_model->getAllWheresun('marketing_man',$querys);
    }
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Marketing Person Add List</h5>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive px-3">
                                                    <table class="table" id="dataTable">
                                                        ...
                                                        <tbody>
                                                            <?php for($i=1;$i<count($allgetmr);$i++){ ?>
                                                            <tr style="text-align:center;">
                                                                <th><?php echo $i;?></th>
                                                                <td><?php echo $allgetmr[$i]->date;?></td>
                                                                <td><?php echo $allgetmr[$i]->mr_unid;?></td>
                                                                <td><?php echo $allgetmr[$i]->username;?></td>
                                                                <td><?php echo $allgetmr[$i]->mobile;?></td>
                                                                <td><?php echo $allgetmr[$i]->email;?></td>
                                                                <td><?php echo $allgetmr[$i]->center;?></td>
                                                                <td><?php echo $allgetmr[$i]->city;?></td> <!--education-->
                                                                <td><?php echo $allgetmr[$i]->address;?></td>
                                                                <!-- <td><?php //echo $getmrdata->address;?></td> -->
                                                                <td>
                                                                    <a href="Marketing_Detail?mrviewkisan=<?php echo $allgetmr[$i]->id?>" class="btn btn-warning btn-sm">
                                                                        View Details
                                                                    </a>
