                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive px-3">
                                                    <table class="table" id="dataTable">
                                                        ...
                                                        <tbody>
                                                            <?php  $i =1;foreach($allmrperson as $allmrshow){ 
                                                                $where = array('id'=>$allmrshow->mr_id,'status'=>'active');
                                                                $datas = $this->Main_model->getAllWheresun('marketing_man',$where);
                                                               foreach($datas as $valdatas){          ?>
                                                            <tr>
                                                                <th><?php echo $i;?></th>
                                                                <td><?php echo $valdatas->mr_unid; ?></td>
                                                                <td><?php echo $valdatas->username;?></td>
                                                                <td><?php echo date("d-m-Y",strtotime($allmrshow->date));?></td>
                                                                <td><?php echo date("H:i:s",strtotime($allmrshow->date));//date_default_timezone_set("Asia/Kolkata"); echo date('h:i:s')?></td>
                                                                <td>Login in <?php echo $valdatas->city;?></td>
                                                                <td>
